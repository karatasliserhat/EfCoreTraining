        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeAddress_StreedAddress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EmployeeAddress_Location = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
